...
Companion to: `agents/protocols/converge.config.applications.md` (per-application `converge.config` field-value matrix).
...
- Canonical schema (locked, NOT modified): `agents/protocols/findings.schema.md`
- Companion contract: `agents/protocols/converge.config.applications.md`
