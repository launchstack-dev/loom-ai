...
# Plan: Spec Upgrades E2E

## Overview

Companion to ROADMAP.md. Provides Invoice and Customer entities plus acceptance criteria so requirements appear on the materialized contract pages. Used by the spec-upgrades-e2e test to verify the full pipeline.
