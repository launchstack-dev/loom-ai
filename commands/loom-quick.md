...
If `$ARGUMENTS` is empty or equals `--help`, print the following help text and stop:
...
After parsing, if the task description is empty, print the help text from Step 0 and stop.
